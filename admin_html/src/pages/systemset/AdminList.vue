<template>
  <div class='page-content'>
    ...
    <el-table border style="margin-top: 15px" :data="roleList" :showPage="false">
      ...
      <el-table-column label="手机号码" prop="phone" width="100"/>
    ...
    <el-dialog :title="dialogTitle" width="500px" :visible.sync="dvEdit">
      <el-form ref="form" :model="form" label-width="100px">
        ...
        <el-form-item label="操作密码">
          <el-input v-model="form.operate_pwd"></el-input>
        </el-form-item>
    ...
    <template v-if="allpage>10">
      <el-pagination @current-change="handleCurrentChange" @size-change="handleSizeChange" :current-page="1" :page-sizes="[10, 20, 50, 100]" :page-size="pageSize"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getUserList() {
        getAdminUserListApi({...this.searchParameter, limit: this.pageSize}).then(res => {
          this.roleList = res.data.data
          this.allpage = res.data.total;
        })
      },
