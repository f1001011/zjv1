    ...
    <div class='page-content'>
        ...
        <div>
            <el-table border style="margin-top: 15px" :data="dataList" :showPage="false">
                <el-table-column label="产品有效期ID" prop="id" width=""/>
                <el-table-column label="产品有效期名称" prop="name" width="" />
                ...
                <el-table-column fixed="right" label="操作" width="150px">
                    ...
                    <el-button type="text" style="color: #FA6962" icon="el-icon-delete" @click="productTimeDel(scope.row)">
                        删除
                    </el-button>
                    </template>
                </el-table-column>
...
<script>
    import {getProductTimeListApi,productTimeEditApi,productTimeAddApi,productTimeDelApi} from '@/api/Product'
        ...
        methods: {
            ...
            */
            getProductList() {
                ...
                getProductTimeListApi(data).then(res => {
                    this.allpage = res.data.total;
                    this.dataList = res.data.data
                })
            },
            
            productTimeDel(scope) {
            ...
            */
            productTimeEdit() {
                productTimeEditApi(this.form).then(res => {
                    if(res.code == 1){
            ...
            */
            productTimeAdd() {
                productTimeAddApi(this.form).then(res => {
                    if(res.code == 1){
                        this.$message({message:res.msg,type: 'success'});
                        this.showDialog = false
                        this.getProductList()
