...
use app\common\model\TouziProductTime as models;
use app\common\traites\PublicCrudTrait;
use app\validate\TouziProductTime as validates;
use think\exception\ValidateException;

class TouziProductTime extends Base
{
    protected $model;
    use PublicCrudTrait;
    ...
    public function add(){
        ...
        if ($find) return $this->failed('产品有效时间已存在');
        //执行修改数据
    ...
    public function edit(){
        ...
        //验证数据
        try {
            validate(\app\validate\TouziProductClass::class)->scene('edit')->check($post);
        } catch (ValidateException $e) {
            // 验证失败 输出错误信息
            return $this->failed($e->getError());
        }
