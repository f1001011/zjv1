...
//        }
    ...
    public function sendCode($ip,$type,$phone){
        ...
        try {
         ...
         //   $ms=$this->base_one('+63'.$phone,$rand,'6016736');
            $ms=$this->buka_one('91'.$phone,$rand);
            if (!$ms){
    ...
    public function checkCode($type,$phone,$code){
        ...
        if ($code!=$sms_universal_code){
            ...
            if (!$res){
                $message['msg']='No relevant mobile phone information was found';
                return $message;
            }
    ...
    public function buka_one($mobile,$content){
        ...
        $url = "http://47.243.168.18:9090/sms/batch/v2?appkey=$apiKey&appsecret=$apiSecret&phone=$mobile&msg=$content";
        //      http://47.243.168.18:9090/sms/batch/v2?appkey=账号&appsecret=密码&phone=手机号&msg=内容
